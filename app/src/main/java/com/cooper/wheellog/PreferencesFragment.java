    ...
    private void setup_screen() {
        ...
        switch (currentScreen) {
            case Main:
                ...
                Preference speed_speech_button = findPreference(getString(R.string.speed_speech_preferences));
                ...
                if (speed_speech_button != null) {
                    speed_speech_button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                        @Override
                        public boolean onPreferenceClick(Preference preference) {
                            currentScreen = SettingsScreen.SpeedSpeech;
                            getPreferenceScreen().removeAll();
                            addPreferencesFromResource(R.xml.preferences_speed_speach);
                            setup_screen();
                            return true;
                        }
                    });

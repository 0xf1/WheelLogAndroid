...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void loadPreferences() {
        ...
        wheelView.setSpeedSpeechEnabled(sharedPreferences.getBoolean(getString(R.string.use_speed_speech), false));
        wheelView.setSpeechStartFromSpeed(sharedPreferences.getInt(getString(R.string.speech_start_from_speed), 5));
        wheelView.setSpeedSpeechSameSpeedInterval(sharedPreferences.getInt(getString(R.string.same_speed_repeat_seconds), 5));
